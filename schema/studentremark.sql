...
CREATE TABLE `studentremark` (
  `studentremarkID` int NOT NULL AUTO_INCREMENT,
  `studentID` int DEFAULT NULL,
  `classID` int DEFAULT NULL,
  `examID` int DEFAULT NULL,
  `sectionID` int DEFAULT NULL,
  `remarks` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`studentremarkID`)
...
LOCK TABLES `studentremark` WRITE;
/*!40000 ALTER TABLE `studentremark` DISABLE KEYS */;
/*!40000 ALTER TABLE `studentremark` ENABLE KEYS */;
UNLOCK TABLES;
