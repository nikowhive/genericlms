...
CREATE TABLE `online_exam_user_status` (
  `onlineExamUserStatus` int NOT NULL AUTO_INCREMENT,
  `onlineExamID` int NOT NULL,
  `duration` int NOT NULL,
  `score` int NOT NULL,
  `totalQuestion` int NOT NULL,
  `totalAnswer` int NOT NULL,
  `nagetiveMark` int NOT NULL,
  `time` datetime NOT NULL,
  `userID` int NOT NULL,
  `classesID` int DEFAULT NULL,
  `sectionID` int DEFAULT NULL,
  `examtimeID` int DEFAULT NULL,
  `totalCurrectAnswer` int DEFAULT NULL,
  `totalMark` decimal(10,0) DEFAULT NULL,
  `totalObtainedMark` decimal(10,0) DEFAULT NULL,
  `totalPercentage` double DEFAULT NULL,
  `statusID` int DEFAULT NULL,
  `status` int NOT NULL COMMENT '0=pending;1=publish',
  `onlineExamUserAnswerID` int DEFAULT NULL,
  `indirect` int DEFAULT 2,
