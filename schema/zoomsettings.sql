...
LOCK TABLES `zoomsettings` WRITE;
/*!40000 ALTER TABLE `zoomsettings` DISABLE KEYS */;
INSERT INTO `zoomsettings` VALUES (1,'','','','','');
/*!40000 ALTER TABLE `zoomsettings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-04-20 14:49:55
