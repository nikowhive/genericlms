...
CREATE TABLE `classwork` (
  `classworkID` int NOT NULL AUTO_INCREMENT,
  ...
  `sectionID` int,
  `subjectID` int,
  `assignusertypeID` int DEFAULT NULL,
  `assignuserID` int DEFAULT NULL,
  `is_published` tinyint(1) DEFAULT '0',
  `unit_id` int DEFAULT NULL,
  `chapter_id` int DEFAULT NULL,
  `course_id` int NOT NULL,
  `order` int DEFAULT '0',
  PRIMARY KEY (`classworkID`)
...
-- Dump completed on 2020-10-06 15:11:04
