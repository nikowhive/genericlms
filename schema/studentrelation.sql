...
CREATE TABLE `studentrelation` (
  `studentrelationID` int NOT NULL AUTO_INCREMENT,
  `srstudentID` int DEFAULT NULL,
  `srname` varchar(40) NOT NULL,
  `srclassesID` int DEFAULT NULL,
  `srclasses` varchar(40) DEFAULT NULL,
  `srroll` int DEFAULT NULL,
  `srregisterNO` varchar(128) DEFAULT NULL,
  `srsectionID` int DEFAULT NULL,
  `srsection` varchar(40) DEFAULT NULL,
  `srstudentgroupID` int NOT NULL,
  `sroptionalsubjectID` int NOT NULL,
  `sranotheroptionalsubjectID` int NOT NULL,
  `srschoolyearID` int DEFAULT NULL,
