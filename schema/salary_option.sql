...
CREATE TABLE `salary_option` (
  `salary_optionID` int NOT NULL AUTO_INCREMENT,
  `salary_templateID` int NOT NULL,
  `option_type` int NOT NULL COMMENT 'Allowances =1, Dllowances = 2, Increment = 3',
...
-- Dump completed on 2020-09-14 16:26:46
