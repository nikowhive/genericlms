...
CREATE TABLE `online_exam` (
  ...
  `bonusMark` int DEFAULT '0',
  `point` int DEFAULT '0',
  `percentage` int DEFAULT '0',
  `showMarkAfterExam` int DEFAULT '0',
  `judge` int DEFAULT '1' COMMENT 'Auto Judge = 1, Manually Judge = 0',
  ...
  `result_published` tinyint DEFAULT '0',
  `auto_published` tinyint DEFAULT '0',
