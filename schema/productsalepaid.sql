...
CREATE TABLE `productsalepaid` (
  `productsalepaidID` int NOT NULL AUTO_INCREMENT,
  `productsalepaidschoolyearID` int NOT NULL,
  ...
  `productsalepaidpaymentmethod` int NOT NULL COMMENT '1 = cash, 2 = cheque, 3 = crediit card, 4 = other',
