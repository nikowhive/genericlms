...
CREATE TABLE `productsale` (
  ...
  `productsalecustomertypeID` int NOT NULL,
  `productsalecustomerID` int NOT NULL,
  ...
  `productsalestatus` int NOT NULL COMMENT '0 = select_payment_status, 1 = due,  2 = partial, 3 = Paid',
  `productsalerefund` int NOT NULL DEFAULT '0' COMMENT '0 = not refund, 1 = refund ',
  `productsaletaxID` int NOT NULL DEFAULT '0',
  ...
  `productsalepaymentterm` int NOT NULL DEFAULT '0',
