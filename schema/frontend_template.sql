...
CREATE TABLE `frontend_template` (
  `frontend_templateID` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `frontend_template` VALUES (1,'home'),(2,'about'),(3,'event'),(4,'teacher'),(5,'gallery'),(6,'notice'),(7,'blog'),(8,'contact'),(9,'admission'),(10,'courses');
...
-- Dump completed on 2020-09-14 16:26:29
