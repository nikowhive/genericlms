...
CREATE TABLE `asset_assignment` (
  `asset_assignmentID` int NOT NULL AUTO_INCREMENT,
  `assetID` int NOT NULL COMMENT 'Description and title',
  `usertypeID` int DEFAULT NULL,
  `check_out_to` int NOT NULL,
  `due_date` date DEFAULT NULL,
  `note` text,
  `assigned_quantity` int DEFAULT NULL,
  `status` int DEFAULT NULL,
  `asset_locationID` int DEFAULT NULL,
...
-- Dump completed on 2020-09-14 16:26:25
