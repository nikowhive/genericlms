...
CREATE TABLE `marksettingrelation` (
  `marksettingrelationID` int NOT NULL AUTO_INCREMENT,
  `marktypeID` int NOT NULL DEFAULT '0',
  `marksettingID` int NOT NULL DEFAULT '0',
  `markpercentageID` tinyint NOT NULL DEFAULT '0',
