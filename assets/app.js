document.addEventListener('DOMContentLoaded', () => {
    const applicationServerKey =
        'BGzgJIO4uc4b5z1T8imf7HN7btMDtxeuhM4xe8nS6NPxZIJoq1068tzKYgVh87s_g80o4_N87vowwub9taf6M64';
    ...
    function push_sendSubscriptionToServer(subscription, method) {
        ...
        return fetch('/jobs/web_push_subscribe', {
                method,
                body: JSON.stringify({
    ...
    sendPushButton.addEventListener('click', () =>
        ...
        .then(subscription => {
            ...
            fetch('/event/send_push_notification', {
                method: 'POST',
