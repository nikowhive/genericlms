        ...
        return this.each(function () {
           ...
           var clear = $('<span/>',{
            ...
            for (var i = 0; i < numberOfOptions; i++) {
                ...
                if(settings.id == 'demo1'){
                    var $checkbox = $('<input> ', {
                        'class': 'mulpitply_checkbox_style1',
                        'type': 'checkbox',
                        value: $this.children('option').eq(i).val(),
                    }).appendTo($label)
                }

                if(settings.id == 'demo2'){
                    var $checkbox = $('<input> ', {
                        'class': 'mulpitply_checkbox_style2',
                        'type': 'checkbox',
                        value: $this.children('option').eq(i).val(),
                    }).appendTo($label)
                }

                if(settings.id == 'demo3'){
                    var $checkbox = $('<input> ', {
                        'class': 'mulpitply_checkbox_style3',
                        'type': 'checkbox',
                        value: $this.children('option').eq(i).val(),
                    }).appendTo($label)
                }

                if(settings.id == 'demo4'){
                    var $checkbox = $('<input> ', {
                        'class': 'mulpitply_checkbox_style4',
                        'type': 'checkbox',
                        value: $this.children('option').eq(i).val(),
                    }).appendTo($label)
                }
