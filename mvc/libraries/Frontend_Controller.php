...
class Frontend_Controller extends MY_Controller {
    ...
    */
    ...
    function __construct () {
        ...
        // foreach($this->data['events'] as $index=> $value){
        //     $medias = $this->event_media_m->get_single_event_media(["eventID"=>$value->eventID]);
        //     $this->data['events'][$index]->photo=isset($medias->attachment)?$medias->attachment:'';
        // }
        /* Close All Data Call */
        // dd($this->data['events']);
        ...
        $this->bladeView->set('backendTheme', $this->_backendTheme);
        $this->bladeView->set('backendThemePath', $this->_backendThemePath);
