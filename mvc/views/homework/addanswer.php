                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <?php if ($usertypeID == 3) { ?>
                                                ...
                                                <div class="input-group image-preview">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button type="button" class="btn btn-default image-preview-clear" style="display:none;">
                                                            ...
                                                            <?= $this->lang->line('homework_clear') ?>
                                                        </button>
                                                        <div class="btn btn-success image-preview-input">
                                                            <span class="fa fa-repeat"></span>
                                                            <span class="image-preview-input-title">
                                                            <?= $this->lang->line('homework_file_browse') ?></span>
                                ...
                                <br>
                                <?php if (customCompute($homework_answer_medias)) : ?>
                                    <div class="content">
                                        <div class="row">
                                            <?php
                                            foreach ($homework_answer_medias as $v) : ?>
                                ...
                                <div class="form-group">
                                    <label for="content" class="col-sm-2 control-label">
                                        <?= $this->lang->line("homework_content") ?>
                                    </label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-8">
                                        <input type="submit" class="btn btn-success submitBtn" value="<?= $this->lang->line("add_homework_ans") ?>" name="submit">
                                    </div>
                                </div>
                                </form>
                        </div>
...
<script language="javascript">
    ...
    function deleteImage(id) {
        ...
        if (result) {
            $.post("<?php echo base_url('homework/deleteAnswerImage'); ?>", {
                id: id
            }, function(data) {
