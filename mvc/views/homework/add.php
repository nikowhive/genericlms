                    ...
                    <div class="card-body">
                                ...
                                <form class="" enctype="multipart/form-data" role="form" method="post" id="add_homework">
                                    ...
                                    ?>
                                            ...
                                            <div class="md-form">
                                                <label for="title"> <?=$this->lang->line("homework_title")?> <span class="text-red">*</span></label>
                                                <input type="text" placeholder="Enter homework title here..." class="form-control" id="title" name="title" value="<?=set_value('title')?>" >
                                    ...
                                    <?php 
                                        if(form_error('description')) 
                                            ...
                                            echo "<div class='form-group' >";
                                    ?>
                                         <label for="description" class="active"><?=$this->lang->line("homework_description")?> <span class="text-red">*</span></label>
                                            <div class="md-form">                                    
                        ...
                        <div class="dvFile" id="dvFile">
                            <div class="increment-block mb-0 row" id="director-uploads" data-number="0" data-changed="0">
                                ...
                                <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_homework")?>" >
...
$('#add_homework').submit(function(){
    $("#add_homework :disabled").removeAttr('disabled');
});
