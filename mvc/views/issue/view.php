            ...
            <div class="col-sm-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#fine" data-toggle="tab"><?=$this->lang->line('issue_fines')?></a></li>
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("issue_issue_date")?> </span>: <?= $book->issue_date ;?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("issue_due_date")?> </span>: <?= $book->due_date_in_bs;?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                  ...
                                  <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                      ...
                                      foreach($invoices as $invoice){ ?>
                                         <tr>
                                            ...
                                            $setButton = '';
                                            if($status == 0) {
                                                $status = $this->lang->line('issue_invoice_notpaid');
                                                $setButton = 'btn-danger';
                                            } elseif($status == 1) {
                                                $status = $this->lang->line('issue_invoice_partially_paid');
                                                $setButton = 'btn-warning';
                                            } elseif($status == 2) {
                                                $status = $this->lang->line('issue_invoice_fully_paid');
