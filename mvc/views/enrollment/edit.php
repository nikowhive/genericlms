                                ...
                                <?php 
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form">
                                            ...
                                            <input type="text" placeholder="Enter enrolment title here..." class="form-control" id="title" name="title" value="<?=set_value('title', $enrollment->title)?>" >
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form">                                     
                                            <input type="text" autocomplete="off" class="form-control" id="from_month" name="from_month" value="<?=set_value('from_month',$enrollment->from_month) ? set_value('from_month',$enrollment->from_month) : date("m-Y") ?>" >
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form">                                     
                                            <input type="text" autocomplete="off" class="form-control" id="to_month" name="to_month" value="<?=set_value('to_month',$enrollment->to_month) ? set_value('to_month',$enrollment->to_month) : date("m-Y") ?>" >
                                             <label for="to_month"> 
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form">                                     
                                            <input type="text" autocomplete="off" class="form-control" id="start_date" name="start_date" value="<?=set_value('start_date',$enrollment->start_date) ? set_value('start_date',$enrollment->start_date) : date("d-m-Y") ?>" >
