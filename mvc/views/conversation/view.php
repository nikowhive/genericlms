                ...
                <div class="box box-success">
                    ...
                    <div class="box-body chat" id="chat-box">
                        ...
                        <?php foreach ($messages as $message) : ?>
                            <div class="item">
                                <img src="<?= imagelink($message->photo,56) ?>" alt="user image" class="online" />
                                <div class="message">
                                    <a href="#" class="name">
                                ...
                                <?php if ($message->attach) : ?>
                                    <div class="attachment">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <a target="_blank" href="<?php echo base_url('uploads/attach/' . $message->attach_file_name); ?>" class="btn btn-primary btn-sm btn-flat"><?= $this->lang->line('open') ?></a>
                    ...
                    <div class="box-footer">
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8">
                                    <input type="submit" value="<?= $this->lang->line('send') ?>" class="btn btn-success">
                                </div>
                            </div>
                        </form>
                    </div>
