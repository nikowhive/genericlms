<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_classgroup')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                ...
                <div class='form-group' >
                    ...
                    <div class="col-sm-4">
                        <div class="switch-wrapper">
                                    <div class="onoffswitch-small">
                                        <input type="checkbox" name="published" class="onoffswitch-small-checkbox" id="course1" value="1">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-0 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_classgroup")?>" >
                        </div>
                    </div>
                </form>
            </div>
