            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="credit" name="credit" value="<?=set_value('credit', $subject->credit)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <textarea type="text" class="form-control" id="prerequisites" name="prerequisites"><?=set_value('prerequisites', $subject->prerequisites)?></textarea>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class='form-group'>
                        ...
                        <div class="col-sm-6">
                            <input id="coscholatics" type="checkbox" name="coscholatics"
                                   data-toggle="toggle" data-on="Yes" data-off="No" <?=$subject->coscholatics == 1 ? 'checked': '' ?>>
                        </div>
                    </div>
