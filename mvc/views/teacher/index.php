    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="mt-4 mb-1 pb-1">
                    <?php if(count($teachers) > 0){ ?>
                        <div class="rightContent" style="float: left;">
                            <a class="btn btn-sm btn-default" target="_blank" href="<?=base_url()?>teacher/exportExcel" title="Excel"><i class="fa fa-file-excel-o"></i> XLSX</a>
                            <a class="btn btn-sm btn-default" target="_blank" href="<?=base_url()?>teacher/exportPDF" title="PDF"><i class="fa fa-file-pdf-o"> PDF Preview</i></a>
                        </div>
                    <?php } ?>
                </div>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=$this->lang->line('teacher_username')?></th>
                        ...
                        <tbody>
                            <?php if(customCompute($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('teacher_username')?>">
