            ...
            <div class="col-sm-9">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <?php if((permissionChecker('teacher_add') && permissionChecker('teacher_delete')) || ($userTypeId == $profile->usertypeID && $this->session->userdata('loginuserID') == $profile->teacherID)) {  ?>
