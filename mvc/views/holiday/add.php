<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <input type="text" autocomplete="off" class="form-control" id="fdate" name="fdate" value="<?= set_value('fdate') ? set_value('fdate') : date("d-m-Y") ?>">
            </div>
            <span class="col-sm-4 control-label">
        ...
        <div class="col-sm-6">
            <input type="text" autocomplete="off" class="form-control" id="tdate" name="tdate" value="<?= set_value('tdate') ? set_value('tdate') : date("d-m-Y") ?>">
        </div>
        <span class="col-sm-4 control-label">
    ...
    <div class="col-sm-6">
        <input type="text" autocomplete="off" class="form-control" id="published_date" name="published_date" value="<?= set_value('published_date') ? set_value('published_date') : date("d-m-Y") ?>">
    </div>
    <span class="col-sm-4 control-label">
...
<div class="col-sm-2">
    <input type="checkbox" class="" id="enable_comment" name="enable_comment" value="1" />
</div>
