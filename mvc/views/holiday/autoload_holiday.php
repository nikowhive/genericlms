                    ...
                    <div class="dropdown">
                        ...
                        <ul id="menu2" class="dropdown-menu" aria-labelledby="drop5">
                            ...
                            <?php if (permissionChecker('holiday_delete')) { ?>
                                <li>
                                    <a href="<?= base_url('holiday/delete/' . $feed->holidayID) ?>" onclick="return confirm('Are you sure you want to delete this holiday?');"><i class="fa fa-trash"></i> Delete</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
        ...
        <?php
                    ...
                    if(count($feed->media) == 1 || $feed->holidayPhoto != ''){
                        ...
                        if ($media1) {
                            ...
                            $thumb_photourl = base_url("uploads/holiday/512/" . $photo);
                        }else{
...
<script>
    $(function() {
        ...
        user_photo = "<?= imagelink($this->session->userdata('photo'),256) ?>";
