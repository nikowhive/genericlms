                                ...
                                <div class="list-inline">
                                    <?php if (isset($feed->is_going)) {
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <a href="#" class="btn btn-primary disabled btn-sm"
                                               id="disabled-going-btn<?= $feed->unique_id ?>" style="display: none">
                                                <i class="fa fa-check"></i> You are going</a
                                            >
                                            <a href="#" class="btn btn-danger disabled btn-sm"
                                               id="disabled-not-going-btn<?= $feed->unique_id ?>">
                                            ...
                                            >
                                            <a href="#" class="btn btn-default btn-sm"
                                               id="not-going-btn<?= $feed->unique_id ?>" style="display: none"
                                               onclick="handleEvent('<?=$feed->unique_id?>', '<?= $feed->itemID ?>', 0)"> <i
                                                        class="fa fa-close"></i>
                                                Not Going</a>
                                        <?php } ?>
                                    <?php } else { ?>
                                        ...
                                        <a href="#" class="btn btn-default btn-sm"
                                           ...
                                           onclick="handleEvent('<?=$feed->unique_id?>', '<?= $feed->itemID ?>', 0)"> <i
                                            ...
                                            Not Going</a>
                                        <a href="#" class="btn btn-danger disabled btn-sm"
                                           id="disabled-not-going-btn<?= $feed->unique_id ?>" style="display: none">
                                    ...
                                    <b><a href="#<?= $type; ?>commentbox<?= $feed->$typeid ?>" role="button" data-toggle="collapse">
                                            ...
                                            if (isset($comments[$type][$feed->$typeid])) {
                                                if ($feed->comment_count == 1) {
                                                    echo '<span class='.$type.'comment_count_' . $feed->$typeid . '>' . $feed->comment_count . '</span> ' . $this->lang->line('feed_comment');
                                                } else {
                                                    echo '<span class='.$type.'comment_count_' . $feed->$typeid . '>' . $feed->comment_count . '</span> ' . $this->lang->line('feed_comments');
                                                }
                                            } else {
                                                echo '<span style="display:none" class='.$type.'comment_' . $feed->$typeid . '><span class=comment_count_' . $feed->$typeid . '>0</span> ' . $this->lang->line('feed_comments') . '</span>';
                                            }
                                            ?>
                                        </a></b>
                                </div>
                   ...
                   <?php } ?>
                    ...
                    <?php if($feed->enable_comment == 1): ?>
                        <div class="card-footer">
                            <div>
                                <b>
                                    <a href="#<?= $type; ?>commentbox<?= $feed->$typeid ?>" role="button" data-toggle="collapse">
                                            <?php
                                            if (isset($comments[$type][$feed->$typeid])) {
                                                if ($feed->comment_count == 1) {
                                                    echo '<span class='.$type.'comment_count_' . $feed->$typeid . '>' . $feed->comment_count . '</span> ' . $this->lang->line('feed_comment');
