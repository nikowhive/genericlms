...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <?php } ?>
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_unit')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" id="add_unit">
                    <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                        <?php
                                $classArray = [ 0 => $this->lang->line("unit_select_class")];
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="unit_name" name="unit_name" value="<?=set_value('unit_name')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="unit_code" name="unit_code" value="<?=set_value('unit_code')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_unit")?>" >
                        </div>
                    </div>
...
$('#add_unit').submit(function(){
    $("#add_unit :disabled").removeAttr('disabled');
});
