                                                    ...
                                                    ?>
                                                                ...
                                                                <div class="action">
                                                                    ...
                                                                    <div class="onoffswitch-small">
                                                                        <input type="checkbox" name="attendance<?= $attendances[$student->studentID]->attendanceID ?>" class="attend onoffswitch-small-checkbox" id="attendance<?= $attendances[$student->studentID]->attendanceID ?>" <?= ($attendances[$student->studentID]->$aday == "P" || $attendances[$student->studentID]->$aday == '') ? 'checked' : ''; ?> onclick="changestatus(this)" data-value="P" value="P" data-key="<?= $attendances[$student->studentID]->attendanceID ?>" date-value="<?= abs($day) ?>" data-target="#addNote">
                                                                        <label class="onoffswitch-small-label switch" for="attendance<?= $attendances[$student->studentID]->attendanceID ?>">
                                                                            <span class="onoffswitch-small-inner" id="inner_switch<?= $attendances[$student->studentID]->attendanceID ?>"></span>
                                                                            <span class="onoffswitch-small-switch"></span>
                                                                        </label>
                                                                    </div>

                                                                    <div hidden data-value="<?= $attendances[$student->studentID]->$aday ?>" id="hiddendiv'<?= $i ?>'" attendance-id="<?= $attendances[$student->studentID]->attendanceID ?>"></div>
                                                                    <div id="absentnote<?= $attendances[$student->studentID]->attendanceID ?>"><?= $student->note ?></div>
                                                                </div>
        ...
        <?php  }
                                                            ...
                                                            if ($monthyear == $attendances[$student->studentID]->monthyear && $attendances[$student->studentID]->studentID == $student->srstudentID && $attendances[$student->studentID]->classesID == $student->srclassesID) {
                                                                ...
                                                                if ($attendances[$student->studentID]->$aday == "P") {
                                                                    ...
                                                                    $amethod = "checked";
                                                                } elseif ($attendances[$student->studentID]->$aday == "AN") {
                                                                    $anmethod = "checked";
                                                                } else {
                                                                    $pmethod = "checked";
                                                                }
                                                                ...
                                                                echo  btn_attendance_radio($attendances[$student->studentID]->attendanceID . '-5', $anmethod, "attendance btn btn-warning absentwithnote", "attendance" . $attendances[$student->studentID]->attendanceID, $this->lang->line('sattendance_absent_with_note'), 'AN');
                                                            }
                                                        }
                                                    }
        ?>
...
<?php $i++;
            ...
            <script type="text/javascript">
                ...
                function addnote() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url('sattendance/addsubjectnote') ?>",
                        data: {
                            "attID": attID,
                            "datevalue": datevalue,
                            "notes": notes,
                ...
                $('.save_attendance').click(function() {
                    ...
                    $('.attend').each(function(i) {
                        ...
                        if ($("input:checkbox[name=" + name + "]").is(":checked")) {
                            var val = $('input:checkbox[name=' + name + ']:checked').val();
                        } else {
                            var val = 'A';
                        }
                        attendance[name] = val;
