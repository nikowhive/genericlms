                    ...
                    <div class="card-body">
                                ...
                                <form class=" " enctype="multipart/form-data" role="form" method="post">
                                    ...
                                    <div class="md-form">
                                        ...
                                        <textarea class="form-control md-textarea" id="description" name="description" rows="4"><?=set_value('description', $assignment->description)?></textarea>
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form--select md-form">
                                                ...
                                                echo form_dropdown("classesID", $array, set_value("classesID", $assignment->classesID), "id='classesID' class='mdb-select'");
                                            ?>
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form--select md-form">
                                             <?php
                                                ...
                                                echo form_dropdown("subjectID", $array, set_value("subjectID", $assignment->subjectID), "id='subjectID' class='mdb-select' disabled");
                                            ?>
                                    ...
                                    ?>
                                        ...
                                        <div class="md-form--select md-form">
                                            <?php
                                                ...
                                                echo form_dropdown("unitId", $unitArray, set_value("unitId", $assignment->unit_id), "id='unitId' class='mdb-select'");
                                            ?>
                                ...
                                ?>
                                        ...
                                        <div class="md-form--select md-form">
                                            <?php
                                                ...
                                                echo form_dropdown("chapterId", $chapterArray, set_value("chapterId", $assignment->chapter_id),
    ...
    $(".image-preview-input input:file").change(function (){     
        ...
        reader.readAsDataURL(file);
            ...
            function deleteImage(id) {
                ...
                if (result) {
                    $.post("<?php echo base_url('assignment/deleteImage'); ?>", {
                        id: id
                    }, function(data) {
