        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?=form_error('anotheroptionalSubjectID') ? ' has-error' : ''  ?>">
                        <label for="anotheroptionalSubjectID" class="col-sm-2 control-label">
                            <?=$this->lang->line("student_another_optionalsubject")?>
                        </label>
                        <div class="col-sm-6">
                            <?php
                            $anotheroptionalSubjectArray = array(0 => $this->lang->line("student_another_select_optionalsubject"));
                            if($optionalSubjects != "empty") {
                                foreach ($optionalSubjects as $anotheroptionalSubject) {
                                    $anotheroptionalSubjectArray[$anotheroptionalSubject->subjectID] = $anotheroptionalSubject->subject;
                                }
                            }

                            echo form_dropdown("anotheroptionalSubjectID", $anotheroptionalSubjectArray, set_value("anotheroptionalSubjectID", $anotheroptionalSubjectID), "id='anotheroptionalSubjectID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('anotheroptionalSubjectID'); ?>
                        </span>
                    </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text"  class="form-control" id="registerNO" name="registerNO" value="<?=set_value('registerNO',$registerNumber)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
    ...
    if(classesID === '0') {
        ...
        $.ajax({
            ...
            success: function(data2) {
                ...
                $('#anotheroptionalSubjectID').html(data2);
            }
        });
    }
});
...
$('#sectionID').change(function(event) {
    ...
    if(sectionID != 0){
        $.ajax({
            type: 'POST',
            url: "<?=base_url('student/autoIncrementRoll')?>",
            data: "id=" + sectionID,
