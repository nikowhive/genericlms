                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?=form_error('anotheroptionalSubjectID') ? ' has-error' : ''  ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("anotheroptionalSubjectID", $anotheroptionalSubjectArray, set_value("anotheroptionalSubjectID", $student->sranotheroptionalsubjectID), "id='anotheroptionalSubjectID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
