		...
		<div class="mainArea">
			<div class="areaTop">
				<div class="studentImage">
				  	<img class="studentImg" src="<?=imagelink($admission['photo'],256)?>" alt="">
				</div>
				<div class="studentProfile">
					<div class="singleItem">
						...
						<div class="single_value">: 
							<?php 
	                            $admissionIDlen = strlen($admission['onlineadmissionID']);
	                            $boxLimit = 8;
	                            ...
	                            $admissionIDArray = str_split($admission['onlineadmissionID']);
