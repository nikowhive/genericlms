            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="duration" name="duration" value="<?=set_value('duration')?>" placeholder="In minute">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="published1" name="published1" value="No" readonly>
                            <input type="hidden"  id="published" name="published" value="2">
                            <!-- <?php
                                $array['0'] = $this->lang->line("online_exam_select");
                                // $array['1'] = $this->lang->line("online_exam_yes");
                                $array['1'] = $this->lang->line("online_exam_no");
