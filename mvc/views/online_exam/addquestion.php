                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php if(isset($subject)) { ?>
                                        <a class="btn btn-success btn-xs mrg" href="<?=base_url('online_exam/generateAllQuestions/?online_exam=').$onlineExam->onlineExamID.'&subject='.$subject->subjectID ?>" <?php isset($subject) ? '':'disabled' ?>>Add All Questions</a>
                                    <?php } else { ?>
                                        <p class="alert alert-warning">To add all the questions at once there should be subject available.</p>
                                    <?php } ?>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box">
                            ...
                            <p>
                                ...
                                <?=($onlineExam->examStatus == 1) ? $this->lang->line('online_exam_onetime') : $this->lang->line('online_exam_multipletime')?>
                            </p>
                            <p>
...
<script type="application/javascript">
    $('#groupID').change(function () {
        ...
        var classID = "<?php echo isset($class->classesID) ? $class->classesID : 0; ?>"
        var subjectID = "<?php echo isset($subject->subjectID) ? $subject->subjectID : 0; ?>"
        $.ajax({
            type: 'POST',
            url: "<?=base_url('online_exam/showQuestions')?>",
            data: {"groupID" : groupID, 'levelID': levelID, 'subjectID': subjectID, 'classID': classID},
            dataType: "html",
