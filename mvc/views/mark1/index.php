                    ...
                    <h5 class="page-header">
                        <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID') || $this->session->userdata('usertypeID') == 1)) { ?>
                            <?php if(permissionChecker('mark_add')) { ?>
                                <a href="<?php echo base_url('kindergarten/add') ?>">
                                            ...
                                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { ?>
                                                <tr>
                                                    ...
                                                    <td data-title="<?=$this->lang->line('action')?>">
                                                        <?php echo btn_view('kindergarten/view/'.$student->studentID."/".$set, $this->lang->line('view')); ?>
                                                    </td>
                                                    <?php } ?>
                                               </tr>
                                            <?php $i++; }} ?>
...
<script type="text/javascript">
    ...
    $('#classesID').change(function() {
        ...
        if(classesID == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('kindergarten/mark_list')?>",
                data: "id=" + classesID,
                dataType: "html",
