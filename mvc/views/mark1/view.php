<?php if(customCompute($profile)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                <?php if(!permissionChecker('mark_view') && permissionChecker('mark_add')) { echo btn_sm_add('kindergarten/add', $this->lang->line('add_sub_mark')); } ?>

                <button class="btn-cs btn-sm-cs" onclick="javascript:printDiv('printablediv')"><span class="fa fa-print"></span> <?=$this->lang->line('print')?> </button>
                <?=btn_add_pdf('kindergarten/print_preview/'.$profile->studentID."/".$profile->srclassesID, $this->lang->line('pdf_preview'))?>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("kindergarten/index/$profile->srclassesID")?>"><?=$this->lang->line('menu_mark')?></a></li>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $('#send_pdf').click(function() {
            ...
            if(error == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?=base_url('kindergarten/send_mail')?>",
