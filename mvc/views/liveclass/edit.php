<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_liveclass')?></li>
        </ol>
    </div>
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title" value="<?=set_value('title', $liveclass->title)?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input autocomplete="false" type="text" class="form-control datetimepicker" id="date" name="date" value="<?=set_value('date', date('d-m-Y h:i: A', strtotime($liveclass->date)))?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="duration" name="duration" value="<?=set_value('duration', $liveclass->duration)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("classesId", $classArray, set_value("classesId", $liveclass->classes_id), "id='classesId' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("sectionId", $sectionArray, set_value("sectionId", $liveclass->section_id), "id='sectionId' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("subjectId", $subjectArray, set_value("subjectId", $liveclass->subject_id), "id='subjectId' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="teacher_join_url" name="teacher_join_url" value="<?=set_value('teacher_join_url',$liveclass->teacher_join_url)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="number" min="5" class="form-control" id="reminder" name="reminder" value="<?=set_value('reminder',$liveclass->reminder)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_liveclass")?>" >
                        </div>
                    </div>
                </form>
            </div>
