...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <?php } ?>
            <li class="active"><?=$this->lang->line('menu_add')?> <?=$this->lang->line('menu_chapter')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" id="add_chapter">
                    <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                           <?php
                                ...
                                $disabled = ($classesID != 0) ? $classesID: '';
                                
                                echo form_dropdown("classesID", $array, set_value("classesID", $classesID), "id='classesID' class='form-control select2' $disabled");
                            ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6" id="ajax-get-subjects">
                           <?php
                                ...
                                $disabled = ($subjectID != 0) ? $subjectID: '';

                                echo form_dropdown("subject_id", $array, set_value("subject_id", $subjectID), "id='subject_id' class='form-control select2' $disabled");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6"  id="ajax-get-units">
                           <?php
                                ...
                                $disabled = ($unit_id != 0) ? $unit_id: '';

                                echo form_dropdown("unit_id", $array, set_value("unit_id", $unit_id), "id='unit_id' class='form-control select2' $disabled");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="chapter_name" name="chapter_name" value="<?=set_value('chapter_name')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="chapter_code" name="chapter_code" value="<?=set_value('chapter_code')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_chapter")?>" >
                        </div>
                    </div>
...
$('#add_chapter').submit(function(){
    $("#add_chapter :disabled").removeAttr('disabled');
});
