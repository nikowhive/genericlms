<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa iniicon-terminalreport"></i> <?=$this->lang->line('final_terminal_report_title')?></h3>
        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active"> <?=$this->lang->line('menu_final_terminalreport')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                <p id="errorMsg" style="padding: 16px;color: red;"></p>
                ...
                <div class="col-sm-4" style="display:none" id="dateDiv">
                ...
                <div id="classTeacherDiv" style="display:none" class="col-sm-4 form-group <?=form_error('class_teacher') ? 'has-error' : ''?>">
                    <div class="col-sm-12">
                ...
                <div id="inchargeDiv"  style="display:none" class="col-sm-4 form-group <?=form_error('incharge') ? 'has-error' : ''?>">
                    <div class="col-sm-12">
                    <label class="control-label" for="incharge">Incharge Signature&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set incharge signature here"></i>
                    </label>
                ...
                <div class="col-sm-4"  style="display:none" id="verifiedByDiv">
                    <div class="<?php echo form_error('verified_by') ? 'form-group has-error' : 'form-group'; ?>" >
                        <label class="control-label">Verified By Name
                        <input type="text" class="form-control" name="verified_by" id="verified_by" placeholder="Select Verified Name">
                    </div>
                </div>
                <div class="col-sm-4"  style="display:none" id="schoolDaysDiv">
                    <div class="<?php echo form_error('school_days') ? 'form-group has-error' : 'form-group'; ?>" >
                        <label class="control-label">School Days
                        <input type="number" class="form-control" name="school_days" id="school_days" placeholder="Select School Days">
                    </div>
                </div>
                <div class="col-sm-4">
...
<script type="text/javascript">
    ...
    $(document).on('change',"#classesID", function() {
        ...
        if(classesID == '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('finalterminalreport/getExam')?>",
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('finalterminalreport/getSection')?>",
                data: {"classesID" : classesID},
                dataType: "html",
                success: function(data) {
                   $('#sectionID').html(data);
    ...
    $(document).on('change',"#sectionID", function() {
        ...
        if(sectionID == '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('finalterminalreport/getStudent')?>",
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('finalterminalreport/getTerminalreport')?>",
            data: passData,
            dataType: "html",
            cache: false,
            contentType: false,
