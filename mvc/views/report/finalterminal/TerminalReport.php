<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('finalterminalreport/pdf/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD.'/'.$date.'/'.$verified_by.'/'.$school_days);
            $excel_download_uri = base_url('finalterminalreport/download_excel/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
            $view_mark = base_url('finalterminalreport/view/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
            //  $excel_download_uri_mark = base_url('finalterminalreport/download_excel_mark/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
        ...
        ?>
        <?php if(permissionChecker('terminalreport')) { ?>
        <a href="<?=$excel_download_uri ?>" class="btn btn-default pdfurl" target="_blank"><i class="fa fa-file"></i> Download Grades</a>
        <?php } ?>
        <?php if(permissionChecker('terminalreport')) { ?>
        <a href="<?=$view_mark ?>" class="btn btn-default pdfurl" target="_blank"><i class="fa fa-file"></i> View Marks</a>
        <?php } ?>
        <?php
        if($this->session->userdata('usertypeID') == 3 || $this->session->userdata('usertypeID') == 4){
            $pdf_preview_uri = base_url('result/finaltermpdf/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
        ?>
...
<div class="box">
    ...
    <div id="printablediv">
        <div class="box-body" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-sm-12">
                    <?php if(customCompute($studentLists)) { 
