<div id="printablediv">
    <div class="box">
        <div class="box-header bg-gray">
            ...
            <!-- <button id="import_temp_db" data-examid="<?php //echo $onlineexamID; ?>" class="btn btn-xs btn-primary" style="margin-top:10px;"> Import Temporary Data</button>  -->
	                            ...
	                            <?php $i = 1; foreach($onlineexam_user_statuss as $onlineexam_user_status)  { ?>
                                    <tr>
	                                    ...
	                                    <td data-title="<?=$this->lang->line('onlineexamreport_status')?>">
											<?php 
											if($onlineexam_user_status->status > 0)
											{
...
<script>
   $('#import_temp_db').click(function(){
        var examID = $(this).data('examid');
		alert(examID);
		$.ajax({
			url: "<?=base_url('onlineexamreport/transferDataFromTempToMainDB')?>",
			type: 'post',
			data: { examid: examid},
