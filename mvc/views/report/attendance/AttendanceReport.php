                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($subjectID == "all") : ?>

                                            <th></th>
                                        <?php else : ?>
                                            <th>Status</th>

                                            <th><?= $this->lang->line('attendancereport_reason') ?></th>
                                        <?php endif; ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($students as $student) {
                                        ...
                                        if ($subjectID == 'all') {
                                            if(isset($attendances[$student->srstudentID])){
                                            foreach ($attendances[$student->srstudentID] as $key => $value) {
                                                $attendanceDay = $value->$day;
                                                // print_r($attendanceDay);   
                                                if ($typeSortForm == 'P' && ($attendanceDay == 'A' || $attendanceDay == NULL || $attendanceDay == 'LE' || $attendanceDay == 'L')) {
                                                    ...
                                                    continue;
                                                } elseif ($typeSortForm == 'A' && ($attendanceDay == 'P' || $attendanceDay == 'LE'  || $attendanceDay == NULL || $attendanceDay == 'L')) {
                                                    continue;
                                                }
                                            }
                                        }
                                    ...
                                    ?>
                                        <?php if ($attendanceDay == 'P') { ?>
                                            <tr style="background-color: #c8facf">
                                            <?php } else if ($attendanceDay == 'A') { ?>
                                            <tr style="background-color: #f5a09a">
                                            <?php } else { ?>
                                            <tr>
                                            <?php } ?>
                                            ...
                                            <?php if ($subjectID == "all" && $typeSortForm != '1') { ?>
                                                <td colspan="3" data-title="Reason">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <?php if (isset($attendances[$student->srstudentID])) {
                                                            $dateday = date('j', strtotime($attendancedate));
                                                            $a = 'a' . $dateday;
                                                            foreach ($attendances[$student->srstudentID] as $key => $value) {
                                                                $attendanceDay1 = $value->$a;
                                                                $sub = $subjects[$value->subjectID]->subject;
                                                                $obj = $this->Sub_attend_note_m->get_single_sub_attendance_note(['attendanceID' => $value->attendanceID]);
                                                                $loop = false;
                                                                if($typeSortForm == $attendanceDay1){
                                                                    ?>
                                                                    
                                                                    <tr>
                                                                        <td><?= $sub ?></td>
                                                                        <td><?= $attendanceDay1 ?> </td>
                                                                        <td><?= ($attendanceDay1 == "A") ? $obj?$obj->$a:'' : '' ?></td>
                                                                    </tr>
                                                            ...
                                                            <?php   }else{ ?>
                                                                <tr>
                                                                        <td><?= $sub ?></td>
                                                                        <td>-</td>
                                                                        <td>Not <?php echo $typeSortForm; ?></td>
                                                                    </tr>
                                                          <?php   }
                                                        } ?>
                                                    </table>
                                        ...
                                        <?php } elseif($subjectID == "all" && $typeSortForm == '1') { 
                                            ?>    
                                        ...
                                        <?php } else{ 
                                            ...
                                            <td data-title="Reason">
                                                ...
                                                if ($attendanceDay == 'A') {
                                                    ...
                                                    if (isset($attendances[$student->srstudentID]->subjectID)) {

                                                        $obj = $this->sattendance_m->getAttendanceSubjectnote($attendances[$student->srstudentID]->attendanceID, date('j', strtotime($date)));
                                                    } else {
