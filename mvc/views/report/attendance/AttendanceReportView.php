        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group col-sm-4" id="attendancetypeDiv">
                    ...
                    <?php
                         $array = array(
                             ...
                             "1" => $this->lang->line("attendancereport_select_all"),
                ...
                <div class="form-group col-sm-4" id="classesDiv">
                    ...
                    <?php
                        $array = array("0" => $this->lang->line("attendancereport_please_select"),"all" => "All");
...
<script type="text/javascript">
    ...
    function makingPostDataPreviousofAjaxCall(field) {
        passData = field;
        if(field['classesID'] == "all"){
            ajaxCallForAllClass(passData);
        }else{
            ajaxCall(passData);
        }
    ...
    function ajaxCallForAllClass(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('attendancereport/getAttendacneReportForAllClass')?>",
            data: passData,
            dataType: "html",
            success: function(data) {
                var response = JSON.parse(data);
