                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="box box-solid " style="border: 1px #ccc solid; border-left: 2px black solid">
                            ...
                            <div class="box-body">
                                <span class='text-blue'><?=$this->lang->line("classesreport_class_number_of_students")?> : <?=customCompute($students)?></span><br>
                                <span class='text-blue'><?=$this->lang->line("classesreport_class_total_subject_assigned")?> : <?=customCompute($subjects)?></span>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    if(isset($routines[$subject->subjectID]) && customCompute($routines[$subject->subjectID])) {
                            ...
                            <div class="box-body">
                                ...
                                <section class="panel">
                                  <div class="profile-db-head bg-maroon-light">
                                      <a>
                                        <?=img(imagelink($teacher->photo),256);?>
                                      </a>
                                    <h1><?=$teacher->name?></h1>
                                  </div>
