            ...
            <div class="row">
                ...
                <div class="col-sm-6 pull-left">
                    <div class="box box-solid classinfo">
                        ...
                        <div class="box-body">
                            <span><?=$this->lang->line("classesreport_class_number_of_students")?> : <?=customCompute($students)?></span><br>
                            <span><?=$this->lang->line("classesreport_class_total_subject_assigned")?> : <?=customCompute($subjects)?></span>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="profile">
                                    <div class="border_image">
                                        <img src="<?=imagelink($teacher->photo,256)?>" alt="">
                                    </div>
                                <h1><?=$teacher->name?></h1>
                              </div>
