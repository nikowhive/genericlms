...
<script type="text/javascript">
    ...
    $(document).on('change',"#classesID", function() {
        ...
        if(classesID == '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('terminalreport1/getExam')?>",
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('terminalreport1/getSection')?>",
                data: {"classesID" : classesID},
                dataType: "html",
                success: function(data) {
                   $('#sectionID').html(data);
    ...
    $(document).on('change',"#sectionID", function() {
        ...
        if(sectionID == '0') {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('terminalreport1/getStudent')?>",
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('terminalreport1/getTerminalreport')?>",
            data: passData,
            dataType: "html",
            cache: false,
            contentType: false,
