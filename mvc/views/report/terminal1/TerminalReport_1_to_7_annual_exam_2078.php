<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('terminalreport1/pdf/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD.'/'.$date);
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <?php if(customCompute($markpercentages)) {
                                                    foreach($markpercentages as $markpercentageID) {
                                                        $markpercentage = isset($percentageArr[$markpercentageID]) ? $percentageArr[$markpercentageID]->markpercentagetype : '';
                                                        if($markpercentage == 'theory' || $markpercentage == 'Theory' || $markpercentage == 'th' || $markpercentage == 'Th' ) { ?>
                                                            <?php $cas += 1; ?>
                                                            <?php 
                                                            if($subjects[0]->finalmark == 100) {
                                                                // echo "<th rowspan='2'>".$markpercentage.' ('.$percentageArr[$markpercentageID]->percentage.')'."</th>"; 
                                                                echo "<th rowspan='2'>".$markpercentage."</th>";
                                                            } else {
                                                                echo "<th></th>";
                                                            } ?>
                                                            <?php }
                                            ...
                                            <tr>
												...
												if(customCompute($markpercentages) && $subjects[0]->finalmark == 100) {
													foreach($markpercentages as $markpercentageID) {
														$markpercentage = isset($percentageArr[$markpercentageID]) ? $percentageArr[$markpercentageID]->markpercentagetype : '';
														if($markpercentage != 'theory' && $markpercentage != 'Theory' && $markpercentage != 'th' && $markpercentage != 'Th' && $markpercentage != 'Co-scholastic') {
                                                ...
                                                <?php
													...
													if(customCompute($markpercentages)) {
														foreach($markpercentages as $markpercentageID) {
															...
															<?php 
																if(isset($studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentageID]) && $f) {
																	 $theoryObtainMark = $studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentageID];
                                                                     $theoryFullMark = $percentageArr[$markpercentageID]->percentage;
                                                                     $theorySubjectMark = markCalculationView($theoryObtainMark, $theoryFullMark, 100);
                                                                     if(customCompute($grades)) { 
                                                                            foreach($grades as $grade) {
                                                                                if(($grade->gradefrom <= $theorySubjectMark) && ($grade->gradeupto >= $theorySubjectMark)) { 
                                                                                    ?>
                                                                                    <?=$grade->grade?>
                                                                                    <?php 
                                                                                }
														...
														foreach($markpercentages as $markpercentageID) {
															...
															$markpercentage = isset($percentageArr[$markpercentageID]) ? $percentageArr[$markpercentageID]->markpercentagetype : '';
															if($markpercentage != 'theory' && $markpercentage != 'Theory' && $markpercentage != 'Co-scholastic' && $markpercentage != 'th' && $markpercentage != 'Th') { ?>
																<td>
																<?php 
																if(isset($studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentageID]) && $f) {
																	// echo $studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentageID];
                                                                    // echo '('.$percentageArr[$markpercentageID]->percentage.')';
                                                                     $casObtainMark = $studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentageID];
                                                                     $casFullMark = $percentageArr[$markpercentageID]->percentage;
                                                                     $casSubjectMark = markCalculationView($casObtainMark, $casFullMark, 100);
                                                                     if(customCompute($grades)) { 
                                                                            foreach($grades as $grade) {
                                                                                if(($grade->gradefrom <= $casSubjectMark) && ($grade->gradeupto >= $casSubjectMark)) { 
                                                                                    ?>
                                                                                    <?=$grade->grade?>
                                                                                    <?php 
                                                                                }
