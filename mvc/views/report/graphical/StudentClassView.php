<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> <?=$this->lang->line('menu_graphicalreport')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group col-sm-4" id="classesDiv">
                    <label><?=$this->lang->line("graphicalreport_class")?><span class="text-red"> * </span></label>
                    <?php
                        $classesArray['0'] = $this->lang->line("graphicalreport_please_select");
                ...
                <div class="form-group col-sm-4" id="sectionDiv">
                    <label><?=$this->lang->line("graphicalreport_section")?></label>
                    <?php
                ...
                <div class="form-group col-sm-4" id="examDiv">
                    <label><?=$this->lang->line("graphicalreport_exam")?><span class="text-red"> * </span></label>
                    <?php
                        $examsArray['0'] = $this->lang->line("graphicalreport_please_select");
                ...
                <div class="col-sm-4">
                    <button id="importbutton" class="btn btn-success" style="margin-top:23px;"> <?=$this->lang->line("graphicalreport_submit")?></button>
                </div>
            </div>
        </div><!-- row -->
    </div><!-- Body -->
...
<script type="text/javascript">
    ...
    function ajaxCall(passData) {
        $.ajax({
            type: 'POST',
            url: "<?=base_url('graphicalreport/getStudentClass')?>",
            data: passData,
            dataType: "html",
            success: function(data) {
