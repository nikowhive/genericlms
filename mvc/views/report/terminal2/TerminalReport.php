<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('terminalreport2/pdf/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD.'/'.$date);
            $excel_download_uri = base_url('terminalreport2/download_excel/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
        ...
        ?>
        <a href="<?=$excel_download_uri ?>" class="btn btn-default pdfurl" target="_blank"><i class="fa fa-file"></i> Download</a>
    </div>
</div>
<div class="box">
                    ...
                    * {
                    ...
                    <div class="report-canvas">
                        <table class="container">
                            ...
                            <tr>
                                <td>
                                    <table class=" remarks-table table-fluid">
                                        <tbody>
                                            <tr>
                                                <td>
