                    ...
                    <div class="right-side--fullHeight  ">
                                ...
                                <div class="container container--sm">
                                    ...
                                    <h3 class="box-title"><i class="fa icon-classwork"></i> <?= $this->lang->line('panel_title') ?></h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="" enctype="multipart/form-data" role="form" method="post" id="add_classwork">
                                                ...
                                                <div class="md-form">
                                                    ...
                                                    <input type="text" placeholder="Enter classwork title here..." class="form-control" id="title" name="title" value="<?= set_value('title') ?>">
                        ...
                        <div class="md-form--select md-form">
                            ...
                            <label for="subjectID" class="mdb-main-label">
                                <?= $this->lang->line("classwork_subject") ?> <span class="text-red">*</span>
                            </label>
                            <span class="text-danger error">
                    ...
                    <input type="submit" class="btn btn-success" value="<?= $this->lang->line("add_classwork") ?>">
                    ...
                    <script>
                        ...
                        $('#add_classwork').submit(function() {
                            $("#add_classwork :disabled").removeAttr('disabled');
                        });
                    </script>