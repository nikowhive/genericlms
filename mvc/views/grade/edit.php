                    ...
                    <form class="" role="form" method="post">
                        ...
                        ?>
                            <div class="md-form">
                                ...
                                <textarea style="resize:none;" class="form-control md-textarea" id="note" name="note"><?=set_value('note', $grade->note)?></textarea>
                        ...
                        ?>
                            <div class="md-form">
                                ...
                                <textarea style="resize:none;" class="form-control md-textarea" id="remarks" name="remarks"><?=set_value('remarks', $grade->remarks)?></textarea>
                                <label for="note" class=" control-label">
                        ...
                        <button type="submit" class="btn btn-success"><?=$this->lang->line("update_grade")?></button>
