...
<head>
    ...
    <link href="<?php echo base_url('assets/inilabs/authpage.min.css'); ?>" rel="stylesheet"  type="text/css">
</head>

<body class="white-bg-login auth-page">

    <div class="container container--xs"  >
        <section class="auth-page-section">
            <header class="client-header mb-3">
        <?php
            if(customCompute($siteinfos->photo)) {
                echo " <img  class='client-logo' height='100' src=".base_url('uploads/images/'.$siteinfos->photo)." />";
            }
        ?>
        <h2 class="client-title"><?php echo $siteinfos->sname; ?></h2> 
