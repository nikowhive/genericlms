                   ...
                   <?php 
                    ...
                    ?>
                        <label for="call" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_call")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="call" name="call" value="<?=set_value('call', $book->call)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                     ...
                     ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" data-role="tagsinput" class="form-control" id="keyword" name="keyword" value="<?=set_value('keyword',$keyword)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <label for="addtional_field" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="checkbox" <?php echo $book->addtional_field == 1? 'checked':'' ?> id="addtional_field" name="addtional_field" value="<?=set_value('addtional_field',1)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('call'); ?>
                        </span>
                    ...
                    <div class="additionalWrapper">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="publisher" name="publisher" value="<?=set_value('publisher',$bookDetails?$bookDetails->publisher:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="published_year" name="published_year" value="<?=set_value('published_year',$bookDetails?$bookDetails->published_year:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="place_of_publication" name="place_of_publication" value="<?=set_value('place_of_publication',$bookDetails?$bookDetails->place_of_publication:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="pages" name="pages" value="<?=set_value('pages',$bookDetails?$bookDetails->pages:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="edition" name="edition" value="<?=set_value('edition',$bookDetails?$bookDetails->edition:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="second_author" name="second_author" value="<?=set_value('second_author',$bookDetails?$bookDetails->second_author:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="third_author" name="third_author" value="<?=set_value('third_author',$bookDetails?$bookDetails->third_author:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="language" name="language" value="<?=set_value('language',$bookDetails?$bookDetails->language:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="volume" name="volume" value="<?=set_value('volume',$bookDetails?$bookDetails->volume:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="source" name="source" value="<?=set_value('source',$bookDetails?$bookDetails->source:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="form" name="form" value="<?=set_value('form',$bookDetails?$bookDetails->form:'')?>" >
                                </div>
                                <span class="col-sm-4 control-label">
                            ...
                            ?>
                                ...
                                <input type="file" class="form-control" id="barcode" name="barcode"/>
                                    <!-- <input type="text" class="form-control" id="barcode" name="barcode" value="<?=set_value('barcode',$bookDetails?$bookDetails->barcode:'')?>" > -->
                                </div>
                                <span class="col-sm-4 control-label">
