        ...
        <div class="card-body">
            ...
            <form class="  mainmarktypeID" id="mainmarktypeID1" role="form" method="post">
                ...
                <fieldset class="mb-3 setting-fieldset">
                 ...
                 <fieldset class="mb-3 setting-fieldset">
                    <legend class="mb-1 setting-legend"><?=$this->lang->line("marksetting_class_wise")?></legend>
                    <div class="row">
                        <?php
            ...
            <form class="form-horizontal mainmarktypeID" id="mainmarktypeID3" role="form" method="post">
                <input type="hidden" name="marktypeID" class="marktypeID">
                 <fieldset class="mb-3 setting-fieldset">
                    <legend class="mb-1 setting-legend"><?=$this->lang->line("marksetting_exam_wise_individual")?></legend>
                    <div class="row">
            ...
            <form class="form-horizontal mainmarktypeID" id="mainmarktypeID4" role="form" method="post">
                <input type="hidden" name="marktypeID" class="marktypeID">
                 <fieldset class="mb-3 setting-fieldset">
                    <legend class="mb-1 setting-legend"><?=$this->lang->line("marksetting_subject_wise")?></legend>
                    <div class="row">
                        <?php $i=0;
                            ...
                            echo '<div class="col-sm-3 '.$margintop.'">';
                                ...
                                if(isset($subjects[$class->classesID]) && customCompute($subjects[$class->classesID])) {
                                    foreach ($subjects[$class->classesID] as $subject) {
                                        echo "<div class='pill pill--sm mt-2 mb-2'> ".$subject->subject."</div>";
