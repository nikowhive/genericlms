                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1"><?=$this->lang->line('onlineadmission_document')?></th>
                            ...
                            <?php if(customCompute($onlineadmissions)) {$i = 1; foreach($onlineadmissions as $onlineadmission) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('onlineadmission_photo')?>">
                                        <?=profileimage($onlineadmission->photo,56)?>
                                    </td>
                                    ...
                                    <td data-title="<?=$this->lang->line('onlineadmission_document')?>">
                                        <?php
                                        if($onlineadmission->document){
                                            echo btn_download('onlineadmission/download_documentd/'.$onlineadmission->onlineadmissionID.'/'.$onlineadmission->classesID, $this->lang->line('download'));
                                        }
                                        ?>
                                    </td>
