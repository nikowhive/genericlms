...
<div class="box">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-8">
                        <input type="checkbox" class="" id="status" name="status" value="public" />
                    </div>
    ...
    <div class="col-sm-4">
        <input type="text" auto class="form-control" id="date" name="date" value="<?= set_value('date') ?>">
    </div>
    <span class="col-sm-4 control-label">
...
<div class="form-group">
    <div class="col-sm-offset-0 col-sm-8">
        <input type="submit" id="saveUsers" class="btn btn-success" value="<?= $this->lang->line("add_class") ?>">
    </div>
</div>
</form>
