<div class="row">
    <div class="col-sm-12" style="margin:10px 0px">
        <?php
            $pdf_preview_uri = base_url('studentresult/kindergartenpdf/'.$examID.'/'.$classesID.'/'.$sectionID.'/'.$studentIDD);
        ?>
                            ...
                            <tr>
                                <td>
                                    <table  class="signature-table table-fluid trim-yaxis-td ">
                                        <tr>
                                            <td valign="center" style="vertical-align: bottom;"><b>Date of Issue:</b> <?=isset($date) ? $date : '' ?></td>
                                            <td valign="center">
                                            <?php
                                                if($setting->class_teacher != 'site.png') {
                                                    ...
                                                    <img height='75' src="<?php echo base_url('uploads/images/site.png') ?>" style="visibility:hidden"/>
                                                <?php }
