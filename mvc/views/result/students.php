                            ...
                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        <a href="<?php echo base_url('studentresult/view/'.$examID.'/'.$student->studentID) ?>" class="btn btn-primary btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View Result"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php $i++; }} ?>
                        </tbody>
