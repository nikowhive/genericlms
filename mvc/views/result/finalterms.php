                                ...
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        <?php if($this->session->userdata('usertypeID') == 3) { ?>
                                            <a href="finalreport/<?=$exam->examID ?>" class="btn btn-primary btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View Result"><i class="fa fa-eye"></i></a>
                                        <?php } else if($this->session->userdata('usertypeID') == 4) { ?>
                                            <a href="finaltermstudents/<?=$exam->examID ?>" class="btn btn-primary btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View Children"><i class="fa fa-child"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php $i++; }} ?>
