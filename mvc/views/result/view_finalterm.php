                    ...
                    <div class="report-canvas">
                        <table class="container">
                            ...
                            <tr>
                                    ...
                                    <table class="reports table-fluid">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="4">Obtained Grade</th>
                                ...
                                <!-- <tr>
                                <td colspan="3"> -->
                                    <table class="trim-yaxis-td remarks-table table-fluid" width="900">
                                        <tr>
                                            <td valign="top">
                                    ...
                                    <table  class="signature-table table-fluid trim-yaxis-td " style="width: 600px;margin-left:200px;">
                                        <tr>
                                            <!-- <td valign="center" style="vertical-align: bottom;"> -->
                                            <!-- <b>Date of Issue:</b> <?//=$date != 0 ? $date : '' ?> -->
                                            <!-- </td> -->
                                            <td valign="center">
                                                <?php
                                ...
                                <?php } ?>
                                <table class="grade-table table-fluid" style="margin-top: 15px;">
                                                    <thead>
                                                        <tr>
                            ...
                            <tr>
                                <td colspan="3" align="center" class="footer-td">NOTE: *=Absent</td>
                            </tr>
                        </table>
                    </div>
                    <!-- </div> -->
