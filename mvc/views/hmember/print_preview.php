        ...
        <div class="mainArea">
            <div class="areaTop">
                <div class="studentImage">
                    <img class="studentImg" src="<?=pdfimagelink($student->photo,256)?>" alt="">
                </div>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?php if(customCompute($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); } } else { echo 'N/A'; }  ?></td>
                        </tr>
                        <tr>
