    ...
    <div class="col-md-4 mt-3 mt-lg-0">
      <div class="md-form-block">
        <div class="md-form--select md-form">
          ...
          echo form_dropdown("subjectID", $array, set_value("subjectID", $subjectID), "id='subjectID' class='mdb-select'  ");
          ?>
        </div>
      </div>
    </div>
...
<script>
  ...
  $(window).on("load", function() {
    ...
    var attdate = $('#attdate').val();
    if (parseInt(id) && parseInt(subjectID) && attdate) {
      $.ajax({
        type: 'POST',
        url: "<?= base_url('sub_attendance/classsectionall') ?>",
        data: {
  ...
  $("#attdate").change(function() {
    ...
    var subjectID = $("#subjectID").val();
    if (parseInt(id) && attdate && parseInt(subjectID)) {
      $.ajax({
        type: 'POST',
        url: "<?= base_url('sub_attendance/classsectionall') ?>",
        data: {
