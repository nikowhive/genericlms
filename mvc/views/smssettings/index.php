                ...
                <div class="col-sm-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?php if($sparrow == 1) echo 'active'; ?>"><a data-toggle="tab" href="#sparrow" aria-expanded="true">Sparrow</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="sparrow" class="tab-pane <?php if($sparrow == 1) echo 'active';?> ">
                                <br>
                                <div class="row">
                                    <div class="col-sm-10">
                                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                            <?php echo form_hidden('type', 'sparrow'); ?>
                                           
                                            <div class="form-group <?= form_error('sparrow_url') ?'has-error':'' ?>" >
                                                <label for="sparrow_url" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_sparrow_url")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_sparrow)): ?>
                                                        <input type="text" class="form-control" id="sparrow_url" name="sparrow_url" value="<?=set_value('sparrow_url')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="sparrow_url" name="sparrow_url" value="<?=set_value('sparrow_url', $set_sparrow['sparrow_url'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('sparrow_url'); ?>
                                                </span>
                                            </div>

                                            <div class="form-group <?= form_error('sparrow_from') ?'has-error':'' ?>" >
                                                <label for="sparrow_from" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_sparrow_from")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_sparrow)): ?>
                                                        <input type="text" class="form-control" id="sparrow_from" name="sparrow_from" value="<?=set_value('sparrow_from')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="sparrow_from" name="sparrow_from" value="<?=set_value('sparrow_from', $set_sparrow['sparrow_from'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('sparrow_from'); ?>
                                                </span>
                                            </div>

                                            <div class="form-group <?= form_error('sparrow_token') ?'has-error':'' ?>" >
                                                <label for="sparrow_from" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_sparrow_token")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_sparrow)): ?>
                                                        <input type="text" class="form-control" id="sparrow_token" name="sparrow_token" value="<?=set_value('sparrow_token')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="sparrow_token" name="sparrow_token" value="<?=set_value('sparrow_token', $set_sparrow['sparrow_token'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('sparrow_token'); ?>
                                                </span>
                                            </div>

                                            <div class="form-group <?= form_error('sparrow_credits') ?'has-error':'' ?>" >
                                                <label for="sparrow_from" class="col-sm-2 control-label">
                                                    <?=$this->lang->line("smssettings_sparrow_credits")?> <span class="text-red">*</span>
                                                </label>
                                                <div class="col-sm-6">
                                                    <?php if (empty($set_sparrow)): ?>
                                                        <input type="text" class="form-control" id="sparrow_credits" name="sparrow_credits" disabled readonly  value="<?=set_value('sparrow_credits')?>" >
                                                    <?php else: ?>
                                                        <input type="text" class="form-control" id="sparrow_credits" name="sparrow_credits"  disabled readonly value="<?=set_value('sparrow_credits', $set_sparrow['sparrow_credits'])?>" >
                                                    <?php endif; ?>
                                                </div>
                                                <span class="col-sm-4 control-label">
                                                    <?php echo form_error('sparrow_credits'); ?>
                                                </span>
                                            </div>
