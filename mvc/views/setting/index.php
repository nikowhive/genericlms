        ...
        <div class="box-body">
            <fieldset class="setting-fieldset">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('photo') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group image-preview photo-preview">
                                    <input type="text" class="form-control image-preview-filename photo-preview-filename" disabled="disabled">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default image-preview-clear photo-preview-clear" style="display:none;">
                                            <span class="fa fa-remove"></span>
                                            <?=$this->lang->line('setting_clear')?>
                                        </button>
                                        <div class="btn btn-success image-preview-input photo-preview-input">
                                            <span class="fa fa-repeat"></span>
                                            <span class="image-preview-input-title photo-preview-input-title">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('principal') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="principal">Principal Signature&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Set principal signature here"></i>
                                </label>
                                <div class="input-group image-preview principal-preview">
                                    <input type="text" class="form-control image-preview-filename principal-preview-filename" disabled="disabled">
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-default image-preview-clear principal-preview-clear" style="display:none;">
                                            <span class="fa fa-remove"></span>
                                            <?=$this->lang->line('setting_clear')?>
                                        </button>
                                        <div class="btn btn-success image-preview-input principal-preview-input">
                                            <span class="fa fa-repeat"></span>
                                            <span class="image-preview-input-title principal-preview-input-title">
                                            <?=$this->lang->line('setting_file_browse')?></span>
                                            <input type="file" accept="image/png, image/jpeg, image/gif" name="principal"/>
                                        </div>
                                    </span>
                                </div>
                                <span class="control-label">
                                    <?=form_error('principal'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('enable_principal_signature') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="enable_principal_signature">Enable Principal Signature&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enable/Disable Principal Signature"></i>
                                </label>
                                    <?php
                                        echo form_dropdown("enable_principal_signature", array("YES" => $this->lang->line("setting_school_yes"),
                                        "NO" => $this->lang->line("setting_school_no"),
                                        ),
                                        set_value("enable_principal_signature", $setting->enable_principal_signature), "id='enable_principal_signature' class='form-control select2'");
                                    ?>
                                <span class="control-label">
                                    <?=form_error('enable_principal_signature'); ?>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('vice_principal_name') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="sname">Vice Principal Name
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="set your site title here"></i>
                                </label>
                                <input type="text" class="form-control" id="vice_principal_name" name="vice_principal_name" value="<?=set_value('vice_principal_name', isset($setting->vice_principal_name) ? $setting->vice_principal_name:'')?>" />
                                <span class="control-label"><?=form_error('vice_principal_name'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('principal_name') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="sname">Principal Name
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="set your site title here"></i>
                                </label>
                                <input type="text" class="form-control" id="principal_name" name="principal_name" value="<?=set_value('principal_name', isset($setting->principal_name) ? $setting->principal_name:'')?>" />
                                <span class="control-label"><?=form_error('principal_name'); ?></span>
                            </div>
                        </div>
                    </div>

                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('schoolDays') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="sname"><?=$this->lang->line("setting_school_days")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="set your site title here"></i>
                                </label>
                                <input type="number" class="form-control" id="schoolDays" name="schoolDays" value="<?=set_value('schoolDays', isset($setting->schoolDays)?$setting->schoolDays:'')?>" />
                                <span class="control-label"><?=form_error('schoolDays'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#close-preview', function(){ 
        $('.photo-preview').popover('hide');
        // Hover befor close the preview
        $('.photo-preview').hover(
            function () {
               $('.photo-preview').popover('show');
        ...
        $('.principal-preview').popover('hide');
        // Hover befor close the preview
        $('.principal-preview').hover(
            function () {
               $('.principal-preview').popover('show');
               $('.content').css('padding-bottom', '120px');
            }, 
             function () {
               $('.principal-preview').popover('hide');
    ...
    $(function() {
        ...
        // Clear event
        $('.photo-preview-clear').click(function(){
            $('.photo-preview').attr("data-content","").popover('hide');
            $('.photo-preview-filename').val("");
            $('.photo-preview-clear').hide();
            $('.photo-preview-input input:file').val("");
            $(".photo-preview-input-title").text("<?=$this->lang->line('setting_file_browse')?>"); 
        }); 
        $('.principal-preview-clear').click(function(){
            $('.principal-preview').attr("data-content","").popover('hide');
            $('.principal-preview-filename').val("");
            $('.principal-preview-clear').hide();
            $('.principal-preview-input input:file').val("");
            $(".principal-preview-input-title").text("<?=$this->lang->line('setting_file_browse')?>"); 
        }); 
        ...
        $(".photo-preview-input input:file").change(function (){     
            var img = $('<img/>', {
                id: 'dynamic',
                width:250,
                height:200,
            ...
            reader.onload = function (e) {
                $(".photo-preview-input-title").text("<?=$this->lang->line('setting_clear')?>");
                $(".photo-preview-clear").show();
                $(".photo-preview-filename").val(file.name);            
                img.attr('src', e.target.result);
                $(".photo-preview").attr("data-content",$(img)[0].outerHTML).popover("show");
                $('.content').css('padding-bottom', '120px');
            }        
            reader.readAsDataURL(file);
        });  
        $(".principal-preview-input input:file").change(function (){     
            var img = $('<img/>', {
                id: 'dynamic',
                width:250,
                height:200,
            ...
            // Set preview image into the popover data-content
            reader.onload = function (e) {
                $(".principal-preview-input-title").text("<?=$this->lang->line('setting_clear')?>");
                $(".principal-preview-clear").show();
                $(".principal-preview-filename").val(file.name);            
                img.attr('src', e.target.result);
                $(".principal-preview").attr("data-content",$(img)[0].outerHTML).popover("show");
                $('.content').css('padding-bottom', '120px');
            }        
            reader.readAsDataURL(file);
        });  
