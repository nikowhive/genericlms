...
<body class="aside-sidebar--opened skin-blue fuelux theme-<?= $siteinfos->backend_theme ?> <?= htmlentities(escapeString($this->uri->segment(1))) == 'courses' && (htmlentities(escapeString($this->uri->segment(2))) != 'index' && htmlentities(escapeString($this->uri->segment(2))) != '') ? 'course-module' : '' ?>">
