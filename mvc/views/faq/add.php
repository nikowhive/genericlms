                                ...
                                <?php 
                                    ...
                                    ?>
                                         <label for="question" class="active"><?=$this->lang->line("faq_question")?> <span class="text-red">*</span></label>
                                            <div class="md-form">                                    
                                                <textarea class="md-textarea form-control"  id="question" name="question"><?=set_value('question')?></textarea>
                                    ...
                                    ?>
                                         <label for="answer" class="active"><?=$this->lang->line("faq_answer")?> <span class="text-red">*</span></label>
                                            <div class="md-form">                                    
                                                <textarea class="md-textarea form-control"  id="description" name="answer" cols="30" rows="3"><?=set_value('answer')?></textarea>
                                   ...
                                   ?>
                                       ...
                                       <div class="col-sm">
                                           <?php
                                               ...
                                               echo form_multiselect("classesID[]", $array, set_value("classesID"), "id='classesID' class='form-control select2'");
                                           ?>
                                       </div>
                                       <span class="text-danger-error">
