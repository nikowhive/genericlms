        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <label for="notice" class="col-sm-2 control-label">
                        <?= $this->lang->line("notice_status") ?>
                    </label>
                    <div class="col-sm-2">
                        <input type="checkbox" class="" id="status" name="status" value="public" <?php echo $notice->status == 'public'?'checked':''; ?> />
                    </div>
            ...
            ?>
                    ...
                    <div class="col-sm-4">
                        <input type="text" autocomplete="off" class="form-control" id="date" name="date" value="<?= set_value('date', date("d-m-Y", strtotime($notice->date))) ?>">
                    </div>
                    <span class="col-sm-4 control-label">
        ...
        ?>
        <label for="notice" class="col-sm-2 control-label">
            <?= $this->lang->line("notice_enable_comment") ?>
        </label>
        <div class="col-sm-2">
            <?php
            $check = $notice->enable_comment == 1 ? 'checked' : ''; ?>
        ...
        <div class="box-footer clearfix">
            <div id="dvPreview">
                <?php foreach ($notice_media as $media) : ?>
                    <span class="pip pip-<?= $media->id; ?>">
                        <img class="imageThumb" src="<?= base_url('uploads/notice/' . $media->attachment); ?>" title="undefined"><br><span class="remove" onclick="deleteImage(<?= $media->id; ?>)">Remove image</span>
                    </span>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        content_css: 'css/content.css'
            ...
            function deleteImage(id) {
                ...
                if (result) {
                    $.post("<?php echo base_url('notice/deleteImage'); ?>", {
                        id: id
                    }, function(data) {
