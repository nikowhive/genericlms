    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><?php echo $this->data['classwork']->title; ?></h3>
            </div>
            <div class="modal-body">
                ...
                <?php endif; ?>
                    <div class="row">
                        <div class="col-md-12 ml-auto"><b>Deadline: </b> <?php echo $this->data['classwork']->deadlinedate; ?></div>
                    </div>
                    <hr>

                    <div class="row ">
                        <div class="col-md-12 ml-auto description more"><?php echo $this->data['classwork']->description  ?>
                        </div>
                        <?php if (strlen($this->data['classwork']->description) > 500) { ?>
                            <div class="read-more"><a href="#" class=""><span>READ MORE</span></a></div>
                        <?php } ?>
                    </div>

                   
                    <?php if (customCompute($classwork_medias)) { ?>
                        <br>
                        <div class="content">
                            <div class="row">
                                    ...
                                    <div class="col-sm-6" id="pip-<?= $v->id; ?>" style="margin-bottom: 1em">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <?php } else {
                                                    echo btn_download('classwork/classworkdownloadFiles/' . $v->id, $this->lang->line('download'));
                                                } ?>
