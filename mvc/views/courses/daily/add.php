<div class="right-side--fullHeight  ">
    <div class="row w-100 ">
        ...
        <div class="course-content">
            <div class="container container--sm">
                ...
                <div class="card card--spaced">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form name="frm" method="post" enctype="multipart/form-data" id="myform">
                                    ...
                                    <div class="md-form">
                                        ...
                                        <input type="text" placeholder="Enter daily title here..." class="form-control" id="title" name="title" value="<?= set_value('title') ?>">
                            ...
                            <div class="md-form">
                                ...
                                <input type="text" autocomplete="off" class="form-control" id="daily_date" name="daily_date" value="<?= set_value('daily_date') ? set_value('daily_date') : date("d-m-Y") ?>">
                                <span class="text-danger error">
                        ...
                        <div class="md-form">
                            <textarea class="md-textarea form-control" id="activities" name="activities" rows="4"><?= set_value('activities') ?></textarea>
                            <!-- <input type="text" placeholder="Enter activities here..." class="form-control" id="activities" name="activities" value="<?= set_value('activities') ?>"> -->
                            <span class="text-danger error">
                    ...
                    <div class="md-form">
                        ...
                        <textarea class="md-textarea form-control" id="assignment" name="assignment" rows="4"><?= set_value('assignment') ?></textarea>
                        <!-- <input type="text" placeholder="Enter assignment here..." class="form-control" id="assignment" name="assignment" value="<?= set_value('assignment') ?>"> -->
                        <span class="text-danger error">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="md-form--select md-form">
                            ...
                            echo form_dropdown("absent_student_count", $array, set_value("absent_student_count", $absent_student), "id='absent_student_count' class='mdb-select'");
                            ?>
                ...
                <div class="col-sm-6">
                    <div class="md-form">
                        ...
                        <input type="text" placeholder="Enter daily present_student here..." class="form-control" id="present_student"  readonly name="present_student" value="<?= $students - $absent_student; ?>">
                    </div>
                </div>
            ...
            <div class="md-form">
                <textarea class="md-textarea form-control" id="absent_students" name="absent_students" rows="4"><?= set_value('absent_students') ?></textarea>
...
<div class="md-form--select md-form">
    ...
    echo form_dropdown("lesson_id", $array, set_value("lesson_id", ''), "id='lesson_id' class='mdb-select' ");

    ?>
    <label for="lesson_id" class="mdb-main-label">
        <?= $this->lang->line("daily_select_lesson") ?> 
    </label>
    <span class="text-danger error">
...
<div class="md-form">
    ...
    <textarea class="md-textarea form-control" id="feedback" name="feedback" rows="4"><?= set_value('feedback') ?></textarea>
...
<div class="md-form">
    ...
    <textarea class="md-textarea form-control" id="remark" name="remark" rows="4"><?= set_value('remark') ?></textarea>
...
<?php echo form_error('upload_Files[]', '<div class="alert-danger">', '</div>'); ?>
<?php echo form_error('caption[]', '<div class="alert-danger">', '</div>'); ?>
