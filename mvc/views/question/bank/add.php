                ...
                <?php
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            if($this->uri->segment(3)){
                                echo form_dropdown("class_id", $array, $set_class, "id='class_id' class='form-control select2' disabled");
                            } else {
                    ...
                    ?>
                        ...
                        <div class="col-sm-6" id="ajax-get-subjects">
                            ...
                            if($this->uri->segment(3)){
                                echo form_dropdown("subject_id", $array, set_value("subject_id",$set_subject), "id='subject_id' class='form-control select2' disabled");
                            } else {
                    ...
                    ?>
                        ...
                        <div class="col-sm-6" id="ajax-get-units">
                            ...
                            if($this->uri->segment(3)){
                                echo form_dropdown("unit_id", $array, set_value("unit", $set_unit), "id='unit_id' class='form-control select2' disabled");
                            } else {
                                echo form_dropdown("unit_id", $array, set_value("unit"), "id='unit_id' class='form-control select2'");
                            }
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6" id="ajax-get-chapters">
                            ...
                            if($this->uri->segment(3)){
                               echo form_dropdown("chapter_id", $array, set_value("chapter_id", $set_chapter), "id='chapter_id' class='form-control select2' disabled");
                            } else {
...
$('#question_bank').submit(function(){
    $("#question_bank :disabled").removeAttr('disabled');
});
