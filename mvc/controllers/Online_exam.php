...
class Online_exam extends Admin_Controller
{
    ...
    */
    ...
    public function postChangeExamStatus($id)
    {
        ...
        $online_exam_questions = $this->online_exam_question_m->get_order_by_online_exam_question(array('onlineExamID' => $id));
        if ($online_exam_questions) {
            ...
            if ($published == 1) {
                $this->session->set_flashdata('success', 'Successfully Exam published');
            } else {
                $this->session->set_flashdata('success', 'Successfully Exam unpublished');
            }
        } else {
            $this->session->set_flashdata('success', 'Please add some question and publish this exam.');
        }
    ...
    protected function rules($type = 2)
    {
        $rules = array(
            ...
            array(
                ...
                'rules' => 'trim|xss_clean|numeric|callback_check_exam_question'
            )
        );
