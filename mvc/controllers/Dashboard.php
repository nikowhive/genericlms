    ...
    class Dashboard extends Admin_Controller
    {
        ...
        */
        ...
        private function _tails()
        {
            ...
            $results = count($this->exam_m->get_published_order_by_exam());
            ...
            $this->data['dashboardWidget']['results']     = customCompute($results);
        ...
        private function _bargraph(){
            ...
            if($outputs){
                ...
                foreach($outputexams as $outputexam){
                    $this->db->select('gpa');
                    $this->db->from('marksentries');
                    $this->db->where(['studentID'=>$loginuserID,'schoolyearID'=>$schoolyearID,'examName'=>$outputexam->examName]);
                    $this->db->order_by('marksentriesID','ASC');
