...
*/
	...
	public function notification(){
		...
		$this->data['usertypes'] = $this->usertype_m->get_usertype();
		//print_r($this->data['usertypes']);die();
		...
		$this->data['subview'] = "mailandsms/notifications";
		$this->load->view('_layout_main', $this->data);
	}
	...
	public function getAlldatas(){
		...
		$accountant = $this->student_m->get_accountant();
		$librarian = $this->student_m->get_librarian();
		$receptionist = $this->student_m->get_receptionist();
		$moderator = $this->student_m->get_moderator();
        $new = array_merge($students,$parents,$teachers,$admin,$accountant,$librarian,$receptionist,$moderator);
	    echo json_encode($new);
	}
    
    public function send_email(){
	 
        $mails = $this->mailandsms_m->get_mails();
        //print_r($mails);die();
 ...
 //            $allStudents = $this->student_m->get_students($classID);
     
 //            echo "<select id=\"demo4\" data-max=\"\" multiple=\"multiple\" style=\"\">";
 ...
 //            echo "<select id=\"demo5\" data-max=\"\" multiple=\"multiple\" style=\"\">";
 //            foreach ($allStudents as $value) {
 //                echo "<option value=\"$value->name\">".$value->name."</option>";
 //            }
 //            echo "</select>";
