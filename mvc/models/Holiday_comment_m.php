...
class Holiday_comment_m extends MY_Model {

	protected $_table_name = 'holiday_comment';
	...
	function get_holiday_comment($array=NULL, $signal=FALSE) {
		$query = parent::get($array, $signal);
		return $query;
	}

	function get_order_by_holiday_comment($array=NULL) {
		$query = parent::get_order_by($array);
		return $query;
	}

	function get_single_holiday_comment($array=NULL) {
		$query = parent::get_single($array);
		return $query;
	}

	function insert_holiday_comment($array) {
		$id = parent::insert($array);
		return $id;
	}

	function update_holiday_comment($data, $id = NULL) {
		parent::update($data, $id);
		return $id;
	}

	public function delete_holiday_comment($id){
		parent::delete($id);
	}

	public function paginatedHolidayComments($limit = '', $start= '',$condition){
...
/* End of file Holiday_comment_m.php */
/* Location: .//D/xampp/htdocs/school/mvc/models/Holiday_comment_m.php */