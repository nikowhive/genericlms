...
class Event_comment_m extends MY_Model {

	protected $_table_name = 'event_comment';
	...
	function get_event_comment($array=NULL, $signal=FALSE) {
		$query = parent::get($array, $signal);
		return $query;
	}

	function get_order_by_event_comment($array=NULL) {
		$query = parent::get_order_by($array);
		return $query;
	}

	function get_single_event_comment($array=NULL) {
		$query = parent::get_single($array);
		return $query;
	}

	function insert_event_comment($array) {
		$id = parent::insert($array);
		return $id;
	}

	function update_event_comment($data, $id = NULL) {
		parent::update($data, $id);
		return $id;
	}

	public function delete_event_comment($id){
		parent::delete($id);
	}

	public function paginatedEventComments($limit = '', $start= '',$condition){
...
/* End of file Event_comment_m.php */
/* Location: .//D/xampp/htdocs/school/mvc/models/Event_comment_m.php */