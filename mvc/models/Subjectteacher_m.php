...
class Subjectteacher_m extends MY_Model {
	...
	public function get_classes_by_teacher(){
		$this->db->select('classes.*,subject.subject');
		$this->db->from('classes');
		$this->db->join('subjectteacher', 'classes.classesID = subjectteacher.classesID', 'RIGHT');
		...
		$this->db->group_by('subjectteacher.classesID');
