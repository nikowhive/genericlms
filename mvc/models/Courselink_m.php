...
class Courselink_m extends MY_Model
{

	protected $_table_name = 'courselink';
	...
	public function get_courselink($id)
	{
	...
	public function get_links_by_course($course_id, $usertypeid = '')
	{
		$this->db->select('cw.* , c.id As coursechapter_id, c.unit, c.unit_id,c.chapter_name');
		$this->db->from('courselink cw');
